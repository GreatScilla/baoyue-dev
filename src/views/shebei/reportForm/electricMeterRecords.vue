...
<script>
import {
  ammeterDataGetTwoReport,
  getAmmeterDataReportExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getAmmeterDataReportExport,
      pdfApi: "/rcm/ammeterData/getReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await ammeterDataGetTwoReport(params);
