  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="ele" label="电量"></el-table-column>
...
<script>
import {
  motorMonitoringGetTwoReport,
  getMotorMonitoringReportExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getMotorMonitoringReportExport,
      pdfApi: "/rcm/motorMonitoring/getReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await motorMonitoringGetTwoReport(params);
