  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="tagName" label="编号"> </el-table-column>
...
<script>
import {
  autoclaveGetTwoReport,
  getAutoclaveReportExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getAutoclaveReportExport,
      pdfApi: "/rcm/autoclave/getReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await autoclaveGetTwoReport(params);
      console.log(123, res);
