...
<script>
import { waterMeterGetTwoReport,getWaterMeterReportExport } from "@/api/shebei/reportForm";
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getWaterMeterReportExport,
      pdfApi: "/rcm/waterMeter/getReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await waterMeterGetTwoReport(params);
