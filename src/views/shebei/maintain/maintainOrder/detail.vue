      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-input v-model="scope.row.hoquantityRequiredw"></el-input>
          </template>
        </el-table-column>
      </el-table>
    </el-dialog>
...
import {addMaintenanceplan} from "@/api/shebei/maintenance"
import see from "./see";
...
export default {
  ...
  methods: {
    feiji(){
      ...
      console.log(this.$refs.laasd.disabled)
    },
    pageOpen(){
      this.ceshi()
    },
   async ceshi(){
     ...
     this.formInline={
       ...
       how:res.data.data.planCycle.replace(/[^0-9]/ig,""),
       region:res.data.data.planCycle.substring(res.data.data.planCycle.length-3),
    ...
    async saveAll(){
      ...
      console.log(para)
      let res = await addMaintenanceplan(para)
    ...
    putSpareBtn(){
      ...
      this.sparetableData=this.saveSpare
    ...
    putStandardBtn(){
      this.maintenancetableData=this.savestandard
