    ...
    <el-dialog
      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline" ref="formOne">
        <el-form-item label="单据编号" >
          <el-input v-model="formInline.number" disabled placeholder="自动生成" style="width: 205px"></el-input>
        </el-form-item>
      ...
      <el-form :inline="true" :model="equipmentForm" class="demo-form-inline" ref="formTwo">
        <el-form-item label="设备编号">
          <el-input v-model="equipmentForm.equipmentCoding" @blur="searchEq" placeholder="请输入正确设备编号" style="width: 205px"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
  async searchEq(){
    let res = await getShebei({equipmentCoding:this.equipmentForm.equipmentCoding})
    this.equipmentForm=res.data.data.records[0]
    console.log(res.data.data.records,777)
    },
    open_all(){
      let now = new Date();
      this.formInline={
