  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="unit_price" label="成本单价"></el-table-column>
        <el-table-column
          prop="oper_number"
          label="出入库数量"
        ></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: stockTakingExport,
      pdfApi: "/erp/stockTaking/getReceiptIssueDetailsReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getReceiptIssueDetailsReport(params);
