  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="oper_number" label="入库数量"></el-table-column>
        <el-table-column
          width="160"
          prop="create_time"
          label="入库时间"
...
<script>
import {
  getWarehousingDetailsReport,
  exportWarehousingDetailsReport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: exportWarehousingDetailsReport,
      pdfApi: "/erp/stockTaking/getWarehousingDetailsReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getWarehousingDetailsReport(params);
