    ...
    <el-row>
      ...
      >
        ...
        <el-table-column
          ...
          label="调整日期"
        ></el-table-column>
        <el-table-column prop="create_user_name" label="制单"></el-table-column>
        ...
        <el-table-column prop="taking_quantity" label="数量"></el-table-column>
        <el-table-column prop="unit" label="单位"></el-table-column>
        <el-table-column prop="depot_name" label="仓库名称"></el-table-column>
        <el-table-column prop="unit_price" label="单位成本"></el-table-column>
        <el-table-column
          prop="unit_total_price"
          label="成本金额"
        ></el-table-column>
      </el-table>
    </el-row>
...
<script>
import {
  getInventoryAdjustmentDetailsReport,
  exportInventoryAdjustmentDetailsReport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: exportInventoryAdjustmentDetailsReport,
      pdfApi: "/erp/stockTaking/getInventoryAdjustmentDetailsReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getInventoryAdjustmentDetailsReport(params);
