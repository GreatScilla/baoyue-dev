  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="oper_number" label="出库数量"></el-table-column>
        <el-table-column
          width="160"
          prop="create_time"
          label="出库时间"
...
<script>
import {
  getDeliveryDetailsReport,
  exportDeliveryDetailsReport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: exportDeliveryDetailsReport,
      pdfApi: "/erp/stockTaking/getDeliveryDetailsReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getDeliveryDetailsReport(params);
