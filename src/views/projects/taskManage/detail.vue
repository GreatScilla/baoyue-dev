    ...
    >
        ...
        <el-col :span="8">
          <el-form-item label-width="100px" label="单据日期:">
           ...
           <el-form-item label="申请部门:">
            ...
            <el-select size="small" v-model="deptId" placeholder="请选择申请部门" @change="changeDept">
              <el-option
      ...
      <el-row>
        ...
        >
          ...
          <el-table-column label="托盘编号" align="center" prop="productSn">
          </el-table-column>
          <el-table-column label="托盘名称" align="center" width="150">
            <template slot="header" slot-scope="scope">
              <span style="color:#F56C6C">*</span>托盘名称
            </template>
            <template slot-scope="scope">
          ...
          <el-table-column label="规格型号" align="center" prop="productCate">
          </el-table-column>
          <el-table-column label="单位" align="center" prop="productType">
          </el-table-column>
          <el-table-column label="仓库" align="center" prop="unit">
          </el-table-column>
          <el-table-column label="报废数量" align="center" width="150">
            <template slot="header" slot-scope="scope">
          ...
          <el-table-column label="报废原因" align="center" width="110">
            <template slot="header" slot-scope="scope">
