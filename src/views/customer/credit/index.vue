...
<template>
  <basic-container>
    ...
    <!-- 表格 -->
    <el-table :data="customerInformationTableData">
      ...
      <el-table-column label="行业分类"> </el-table-column>
      ...
      <el-table-column prop="control" label="销售员"> </el-table-column>
