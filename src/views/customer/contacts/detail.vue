  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item required label="客户名称:" prop="customerInformationForm.personnelFileBase.name">
            ...
            <el-form-item label="部门:">
              <span v-if="operationState === 'details'"> {{customerInformationForm.personnelFileBase.sex}}</span>
          ...
          <el-col :span="12">
            <el-form-item label="联系人:">
              ...
              <el-input
                ...
                size="small"
                placeholder="请输入"
                v-model="customerInformationForm.personnelFileBase.jobNumber">
              </el-input>
            </el-form-item>
            ...
            <el-form-item  label="联系电话:">
              <span v-if="operationState === 'details'"> {{customerInformationForm.personnelFileBase.deptName}}</span>
              <el-input
                v-else
                size="small"
                placeholder="请输入"
