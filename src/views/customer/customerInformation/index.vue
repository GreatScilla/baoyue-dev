...
<template>
  <basic-container>
    ...
    <el-row class="operation-function">
      <el-button size="small" icon="el-icon-search" type="primary" @click="searchDialogVisible = true">
        查 询
      </el-button>
    ...
    >
      ...
      <el-table-column prop="type" label="客户分类" width="180">
      </el-table-column>
      <el-table-column prop="industry_classification" label="行业分类">
      </el-table-column>
      <el-table-column prop="industry_classification" label="法定代表人">
      </el-table-column>
<!--      <el-table-column prop="legal_representative" label="法定代表人">-->
<!--        <template slot-scope="scope">-->
<!--          &lt;!&ndash; {{scope.row.principalName || "无"}}  &ndash;&gt;-->
<!--        </template>-->
<!--      </el-table-column>-->
      <el-table-column prop="the_salesman" label="销售员">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getProvinceData(){
      ...
      column.dicData = getProvinceData()
    },
    // 查询
    onSearch(value){
      console.log(value)
    ...
    async handleList(...arg) {
      ...
      this.customerInformationTableData = res.data.data.records
    ...
    to(operationState,row){
      if (operationState === 'details') {
        this.$router.push({
          path: "/customer1/customerInformation/detail",
          query: {
            operationState,
            row
          }
        ...
        this.$router.push({
          path: "/customer1/customerInformation/addEdit",
          query: {
            operationState,
            row
          }
