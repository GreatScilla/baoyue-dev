  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column width="140" prop="number" label="单据编号"></el-table-column>
        <el-table-column prop="type_class" label="单据类型"></el-table-column>
        <el-table-column prop="project_name" label="项目名称"></el-table-column>
        <el-table-column prop="organ_name" label="客户名称"></el-table-column>
        <el-table-column width="180" prop="create_time" label="单据日期"></el-table-column>
        <el-table-column width="140" prop="product_sn" label="产品编码"></el-table-column>
...
<script>
import {
  getPageNotAccountStatementReport,
  getNotAccountStatementExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getNotAccountStatementExport,
      pdfApi: "/erp/accountStatement/getNotAccountStatementReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getPageNotAccountStatementReport(params);
      console.log("xswdz", res);
