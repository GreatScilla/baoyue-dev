  ...
  <basic-container>
    ...
    >
      ...
      >
        ...
        <el-form-item label="销售员">
          <el-input v-model="searchForm.hands_person_name" clearable></el-input>
        </el-form-item>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="license_number" label="车辆"></el-table-column>
        <el-table-column prop="volumeAlias" label="单位体积"></el-table-column>
        <el-table-column prop="create_user" label="制单人"></el-table-column>
      </el-table>
    </el-row>
...
<script>
import { getShopDaily, getShopDailyExport } from "@/api/salesManage/reportForm";
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getShopDailyExport,
      pdfApi: "/erp/shopOrder/getShopDailyReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getShopDaily(params);
