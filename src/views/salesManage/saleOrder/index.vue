...
<template>
  <basic-container>
    ...
    <el-row class="operation-function">
      <el-button
        v-if="permission.sale_order_expore"
        size="small"
        icon="el-icon-search"
        type="primary"
      ...
      <el-button
        v-if="permission.sale_order_add"
        size="small"
        icon="el-icon-plus"
        type="primary"
        @click="handleAdd"
      ...
      >
      <!-- <el-button
        v-if="permission.sale_order_audit"
        size="small"
      ...
      > -->
      <el-button
        v-if="permission.sale_order_delete"
        size="small"
        icon="el-icon-delete"
        type="danger"
        plain
      ...
      >
        ...
        <el-table-column width="160" label="操作" fixed="right">
          <template slot-scope="scope">
            ...
            ></el-divider>
            <el-tooltip
              v-if="permission.sale_order_edit"
              class="item"
              effect="dark"
              content="编辑"
              placement="bottom"
...
export default {
  ...
  methods: {
    ...
    orderChange(row) {
      this.$router.push({
        path: "/salesManage/changeSaleOrder/orderChange",
        query: {
          data: row,
        },
      });
