        ...
        <el-row>
          <el-col :span="12" v-if="type != 'add'">
            <el-form-item label="班组工单号:">
              <span v-if="type === 'detail'">{{ form.jobSn }}</span>
              <el-input
                v-else
                size="small"
                v-model="form.jobSn"
          ...
          <el-col :span="12">
            <el-form-item required label="班组:" prop="type">
...
export default {
  ...
  computed: {
    ...
    modulus() {
      return (
        Math.ceil(Number(this.form.sum) / this.singleModeVolume) || 0
      );
    },
    //块数
    wordCount() {
