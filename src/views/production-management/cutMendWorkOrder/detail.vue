    ...
    >
      <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="现产品编码:">
              <span>{{ form.materialSnNew }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="现产品名称:">
              <span>{{ form.materialNameNew }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="现规格型号:">
              <span>{{ form.modelNew }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="合格数量:">
              <span>{{ form.qualifiedSum }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="报废数量:">
              <span>{{ form.scrapSum }}</span>
            </el-form-item>
          </el-col>
          <!-- <el-col :span="12">
            <el-form-item label="操作员:">
              <span>{{ form.handsPersonName }}</span>
            </el-form-item>
          </el-col> -->
        </el-row>
      </el-row>
