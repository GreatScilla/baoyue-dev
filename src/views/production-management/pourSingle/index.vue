...
<template>
  <basic-container>
    ...
    <el-row style="margin-bottom: 20px">
      <el-button
        v-if="permission.pourSingle_expore"
        size="small"
        icon="el-icon-search"
        type="primary"
        ...
        >查 询</el-button
      >
      <el-button v-if="permission.pourSingle_delete" size="small" @click="handleDelete()"> 批量删除 </el-button>
       <el-button
       v-if="permission.pourSingle_export"
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column width="100" label="操作" fixed="right">
          <template slot-scope="scope">
            <router-link
              v-if="permission.pourSingle_detail"
              :to="{
                path: '/production-management/pourSingle/detail',
            ...
            <el-tooltip
              v-if="permission.pourSingle_delete"
              class="item"
              effect="dark"
              content="删除"
              placement="bottom"
            >
              ...
              <el-divider direction="vertical"></el-divider>
            <el-tooltip
              v-if="permission.pourSingle_putSeal"
              class="item"
              effect="dark"
              content="打印"
              placement="bottom"
...
import {
  getPouringWorkOrderByPage,
  deletePouringWorkOrder,
  getPouringWorkOrderExport
...
export default {
  ...
  data() {
    return {
      deleteApi: deletePouringWorkOrder,
      exportApi:getPouringWorkOrderExport,
      pdfIdApi:"/mes/pouringWorkOrder/getPouringWorkOrderReportPDF",
      ids: [], //id
      teamList: [],
