...
<template>
  <basic-container>
    ...
    >
      <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item required label="生产车间:" prop="manufacturingShop">
              ...
              <el-select v-else v-model="form.manufacturingShop">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item required label="生产产线:" prop="productionLine">
              ...
              <el-select
                v-else
                :disabled="!form.manufacturingShop"
          ...
          <el-col :span="12">
            <el-form-item required label="模数:">
          ...
          <el-col :span="12">
            <el-form-item label="强度:">
              ...
              <el-select v-model="form.intensity" placeholder="请选择" v-else>
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="密度:">
              ...
              <el-select v-model="form.density" placeholder="请选择" v-else>
                <el-option
          ...
          <el-col :span="12">
            <el-form-item required label="交货日期:" prop="deliveryDate">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item required label="产品配方:" prop="productFormula">
    ...
    >
      <productDia
        @on-cancel="checkProductVisible = false"
...
export default {
  ...
  methods: {
    ...
    async getDetailInfo() {
      ...
      const res = await getProductionPlanByPageDetail({
        id: id,
      });
      this.form = res.data.data.records[0];
      this.form.type = this.form.type.toString();
      const res2 = await listProductData({ productSn: this.form.materialSn });
      this.singleModeVolume = res2.data.data.records[0].singleModeVolume;
      this.volume = res2.data.data.records[0].volume;
    ...
    async addProductList(val) {
      ...
      const res1 = await queryItemByCategoryId({ productNo: val.productSn });
      this.qualityInspectionList = res1.data.data;
    ...
    async saveProducePlan() {
      ...
      if (
        this.form.productionPlanSubList.some(
          (val) => val.sum == null || val.sum.toString() == ""
        )
      ) {
      ...
      //  this.$router.push("/production-management/producePlan");
    },
    // 取消
    cancel() {
      this.$router.back();
