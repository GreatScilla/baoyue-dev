  ...
  <basic-container>
    ...
    >
      ...
      >
        ...
        <el-form-item label="记录人">
          <el-input v-model="searchForm.notekeeper"></el-input>
        </el-form-item>
        <el-form-item label="班长">
          <el-input v-model="searchForm.squadLeader"></el-input>
        </el-form-item>
    ...
    <el-row style="margin: 10px 0">
      ...
      <el-button
        ...
        icon="el-icon-plus"
        type="primary"
        @click="$router.push('/production-management/pipePosition/add')"
        >新 增</el-button
      >
    </el-row>
    <el-row>
      ...
      >
        ...
        <el-table-column prop="notekeeper" label="记录人"></el-table-column>
        <el-table-column prop="squadLeader" label="班长"></el-table-column>
        <el-table-column
          prop="anlagenzustand"
          label="本班设备工艺异常情况"
        ></el-table-column>
        <el-table-column width="130" label="操作" fixed="right">
          <template slot-scope="scope">
            <router-link
              :to="{
                path: '/production-management/pipePosition/edit',
            ...
            <router-link
              :to="{
                path: '/production-management/pipePosition/detail',
                query: { data: scope.row },
              }"
            >
              <el-tooltip
...
import {
  pipePositionPage,
  pipePositionDel,
  getPipePositionRecordReportPDF,
...
export default {
  ...
  data() {
    return {
     ...
     recordForm: {}, //暂存数据
      ...
      multipleSelection: [],
      pdfIdApi: getPipePositionRecordReportPDF,
    };
  },
  computed: {
  ...
  beforeRouteEnter(to, from, next) {
    if (from.name === "修改蒸养配气岗位操作记录表" || from.name === "蒸养配气岗位操作记录表详情") {
  ...
  methods: {
    ...
    async handleList() {
      ...
      const res = await pipePositionPage(params, this.searchForm);
