  ...
  <basic-container>
    ...
    >
      ...
      >
        ...
        <el-form-item label="排程号">
          <el-input v-model="searchForm.planSn"></el-input>
        </el-form-item>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column width="140" prop="orderSn" label="工单号">
        </el-table-column>
        <el-table-column
          width="140"
          prop="planSn"
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: jobBookingExport,
      pdfApi: "/mes/jobBooking/getJobBookingReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getJobBookingReport(params);
