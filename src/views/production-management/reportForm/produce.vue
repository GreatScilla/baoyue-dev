  ...
  <basic-container>
    ...
    >
      ...
      >
        <el-form-item label="客户名称">
          <el-input
            v-model.trim="searchForm.memberUserName"
            clearable
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="开始时间">
          <el-date-picker
            ...
            v-model.trim="searchForm.startTime"
            type="date"
            placeholder="请选择"
            clearable
          >
        ...
        <el-form-item label="结束时间">
          <el-date-picker
            ...
            v-model.trim="searchForm.endTime"
            type="date"
            placeholder="请选择"
            clearable
          >
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column width="150" prop="receiptNo" label="单据编号">
        </el-table-column>
        <el-table-column
          width="150"
          prop="createTime"
...
export default {
  ...
  data() {
    return {
      ...
      pdfApi: "/mes/productionplan/getProductionPlanReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getProductionPlanReport(params);
