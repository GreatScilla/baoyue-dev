    ...
    >
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item required label="入库日期:" prop="depotHead.outJoinTime">
            <span v-if="operationState === 'details'">{{inboundManageForm.depotHead.outJoinTime}}</span>
            <el-date-picker
              v-else
        ...
        <el-col :span="8">
          <el-form-item label="扫码:">
            <span v-if="operationState === 'details'">{{inboundManageForm.depotHead.inboundName}}</span>
            <el-input
              v-else
              size="small"
      ...
      <el-row>
        ...
        >
          ...
          <el-table-column label="入库成本单价" align="center" width="120" prop="unitPrice">
            <template slot-scope="scope">
          ...
          <el-table-column label="入库成本" align="center" prop="unitTotalPrice">
          </el-table-column>
        </el-table>
      </el-row>
