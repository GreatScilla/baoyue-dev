...
<template>
  <basic-container>
    ...
    <el-row style="margin-bottom: 20px;">
      ...
      <el-button size="small" icon="el-icon-printer" type="primary" plain>作废</el-button>
    </el-row>
    <el-row>
      <el-table
      ...
      >
        ...
        <el-table-column prop="createTime" label="经手人">
        </el-table-column>
        <el-table-column prop="createTime" label="仓库">
        </el-table-column>
        <el-table-column prop="createTime" label="经手部门">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    to(operationState,row) {
      this.$router.push({
        path: "/logistics/tray/palletInventory/detail",
        query: {
          operationState,
          row
        }
