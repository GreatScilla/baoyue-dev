  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="productType" label="规格型号"></el-table-column>
...
<script>
import {
  getPageTrayInventoryReport,
  getTrayInventoryExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getTrayInventoryExport,
      pdfApi: "/erp/depotHead/getTrayInventoryPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getPageTrayInventoryReport(params);
