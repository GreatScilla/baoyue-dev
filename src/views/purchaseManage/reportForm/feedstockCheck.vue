  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="check_num" label="合格数量"></el-table-column>
        <el-table-column prop="check_person" label="检验人"></el-table-column>
      </el-table>
    </el-row>
...
<script>
import {
  getPagePurchaseCheckReport,
  getPurchaseCheckExport
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getPurchaseCheckExport,
      pdfApi: "/erp/purchaseCheck/getPurchaseCheckReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getPagePurchaseCheckReport(params);
