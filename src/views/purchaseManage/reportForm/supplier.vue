  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column width="126" prop="name" label="供应商">
        </el-table-column>
        <el-table-column
          width="130"
          prop="phone"
        ...
        <el-table-column
          prop="settlement_contact_unit_name"
          label="结算方式"
        ></el-table-column>
...
<script>
import { getSupplier, getSupplierExport } from "@/api/purchase/reportForm";
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getSupplierExport,
      pdfApi: "/base/contactUnitBase/getSupplierReportPDF",
    };
  },
  computed: {
