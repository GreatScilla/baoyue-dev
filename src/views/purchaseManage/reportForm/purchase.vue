    ...
    <el-row>
      ...
      >
        ...
        <el-table-column
          ...
          label="采购日期"
        ></el-table-column>
        <el-table-column prop="type" label="采购类型"></el-table-column>
        <el-table-column
          width="140"
          prop="supplier_name"
          label="供应商名称"
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getPurchaseOrderExport,
      pdfApi: "/erp/purchaseOrder/getPurchaseOrderReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getPagePurchaseOrderReport(params);
