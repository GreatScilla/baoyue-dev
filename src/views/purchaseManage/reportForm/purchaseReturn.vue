    ...
    >
      ...
      >
        <el-form-item label="源订单号">
          <el-input v-model="searchForm.purchase_check_sn" clearable></el-input>
        </el-form-item>
...
<script>
import {
  getPagePurchaseReturnReport,
  getPurchaseReturnExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getPurchaseReturnExport,
      pdfApi: "/erp/purchaseReturn/getPurchaseReturnReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getPagePurchaseReturnReport(params);
