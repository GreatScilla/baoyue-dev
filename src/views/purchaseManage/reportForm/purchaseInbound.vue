  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="check_status" label="单据状态"></el-table-column>
        <el-table-column
          prop="purchase_depot"
          label="部门名称"
        ></el-table-column>
        <el-table-column prop="purchase_man" label="采购员"></el-table-column>
        <el-table-column
        ...
        <el-table-column
          prop="product_send_num"
          label="已进货数量"
        ></el-table-column>
        <el-table-column prop="check_num" label="验收数量"></el-table-column>
        <el-table-column prop="refund_num" label="验退数量"></el-table-column>
        <el-table-column prop="real_amount" label="采购单价"></el-table-column>
        <el-table-column prop="sale_price" label="采购金额"></el-table-column>
      </el-table>
    </el-row>
...
<script>
import {
  getPagePurchaseStockReport,
  getPurchaseStockExport,
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      exportApi: getPurchaseStockExport,
      pdfApi: "/erp/purchaseStock/getPurchaseStockReportPDF",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async handleList(...arg) {
      ...
      const res = await getPagePurchaseStockReport(params);
