  ...
  <basic-container>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="url" label="IP地址"> </el-table-column>
        <el-table-column prop="position" label="摄像头位置"> </el-table-column>
        <el-table-column prop="isOpened" label="是否启用">
          <template slot-scope="scope">
            <span>{{ scope.row.isOpened | isOpenedName }}</span>
          </template>
        </el-table-column>
