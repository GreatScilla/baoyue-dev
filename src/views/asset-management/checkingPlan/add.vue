      ...
      <el-row>
        ...
        <el-col v-if="type !== 'add'" :span="12">
          <el-form-item required label="计划单号:">
            <el-input
              v-if="type !== 'detail'"
              v-model="form.spotCheckPlanSn"
              disabled
            ></el-input>
            <span>{{ form.spotCheckPlanSn }}</span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item required label="点检部门:">
            <el-input
              v-if="type !== 'detail'"
        ...
        <el-col :span="12">
          <el-form-item required label="点检时间:">
            <el-input
              v-if="type !== 'detail'"
...
export default {
  ...
  methods: {
    ...
    async getDetailInfo() {
      ...
      const res = await getCheckingPlanDetails({ id: id });
