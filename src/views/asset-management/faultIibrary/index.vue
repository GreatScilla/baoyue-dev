  ...
  <basic-container>
    ...
    >
      <el-form ref="form" :model="form" label-width="90px" class="form-footer">
        <el-form-item label="标准编码:" prop="billNo">
          <el-input
            placeholder="请输入标准编码"
            v-model="form.billNo"
          ></el-input>
        </el-form-item>
        <el-form-item label="故障名称:" prop="person">
          <el-input
            placeholder="请输入故障名称"
            v-model="form.person"
          ></el-input>
        </el-form-item>
        <el-form-item label="维修位置:" prop="billNo">
          <el-input
            placeholder="请输入维修位置"
            v-model="form.billNo"
          ></el-input>
        ...
        <el-form-item label="创建人:" prop="person">
          <el-input placeholder="请输入创建人" v-model="form.person"></el-input>
        </el-form-item>
    ...
    <el-row class="operation-function">
      <el-button
        v-if="permission.faultIibrary_expore"
        size="small"
        icon="el-icon-search"
        type="primary"
      ...
      <el-button
        v-if="permission.faultIibrary_add"
        size="small"
        icon="el-icon-plus"
        type="primary"
        @click="handleAdd"
      ...
      > -->
      <el-button
        v-if="permission.faultIibrary_export"
        size="small"
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="faultSn" label="故障编码" width="150px">
        </el-table-column>
        <el-table-column prop="faultName" label="故障名称"> </el-table-column>
        <el-table-column prop="faultType" width="130" label="故障分类">
        </el-table-column>
        <el-table-column prop="maintainParts" label="维修位置">
        </el-table-column>
        <el-table-column prop="maintainMethod" label="维修方法">
        </el-table-column>
        ...
        <el-table-column width="110" label="操作" fixed="right">
          <template slot-scope="scope">
            <el-tooltip
              v-if="permission.faultIibrary_edit"
              class="item"
              effect="dark"
              content="编辑"
              placement="bottom"
            ...
            <el-tooltip
              v-if="permission.faultIibrary_detail"
              class="item"
              effect="dark"
              content="详情"
              placement="bottom"
            ...
            <el-divider direction="vertical"></el-divider>
            <el-tooltip
              v-if="permission.faultIibrary_delete"
              class="item"
              effect="dark"
              content="删除"
              placement="bottom"
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      // 新增
      this.$router.push({
        path: "/asset-management/faultIibrary/add",
      });
    },
    handleEdit(row) {
      // 修改
      this.$router.push({
        path: "/asset-management/faultIibrary/edit",
        query: {
          data: row,
        },
      });
    ...
    handleDetail(data) {
      // 详情
      this.$router.push({
        path: "/asset-management/faultIibrary/detail",
        query: {
          data,
        },
      });
