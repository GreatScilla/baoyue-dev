  ...
  <basic-container>
    ...
    >
      <el-form ref="form" :model="form" label-width="90px" class="form-footer">
        ...
        <el-form-item label="点检名称:" prop="planName">
          <el-input placeholder="请输入" v-model="form.planName"></el-input>
        </el-form-item>
        <el-form-item label="点检部门:" prop="maintenanceDepartment">
          <el-input
            placeholder="请输入"
    ...
    <el-row class="operation-function">
      <el-button
      v-if="permission.workCheck_expore"
        size="small"
        icon="el-icon-search"
        type="primary"
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="spotCheckDepartment" label="点检部门">
        </el-table-column>
        <el-table-column prop="spotCheckTime" label="点检时间">
        </el-table-column>
        ...
        <el-table-column width="130" label="操作" fixed="right">
          <template slot-scope="scope">
            <el-tooltip
            v-if="permission.workCheck_return"
              class="item"
              effect="dark"
              content="指派"
              placement="bottom"
            ...
            <el-divider direction="vertical"></el-divider>
            <el-tooltip
            v-if="permission.workCheck_detail"
              class="item"
              effect="dark"
              content="详情"
              placement="bottom"
            ...
            <el-divider direction="vertical"></el-divider>
            <el-tooltip
            v-if="permission.workCheck_delete"
              class="item"
              effect="dark"
              content="删除"
              placement="bottom"
    ...
    >
      <el-form
        ...
        class="form-footer"
      >
        <el-form-item label="执行点检部门:" prop="billNo">
          <el-select
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      // 结果反馈
      this.$router.push({
        path: "/asset-management/workCheck/edit",
        query: {
          data: row,
        },
      });
