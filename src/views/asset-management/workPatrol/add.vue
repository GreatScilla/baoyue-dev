  ...
  <div class="pages addPages">
    ...
    >
      <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item required label="巡检编号:">
              <span>{{ form.spotCheckOrderSn }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item required label="巡检名称:" prop="spotCheckName">
              <span>{{ form.spotCheckName }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item required label="巡检部门:" prop="spotCheckDepartment">
              <span>{{ form.spotCheckDepartment }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item required label="巡检人:" prop="spotCheckPerson">
              <span>{{ form.spotCheckPerson }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item required label="巡检时间:" prop="spotCheckTime">
...
export default {
  ...
  methods: {
    ...
    keep() {
      ...
      this.$router.push({
        path: "/asset-management/workPatrol",
      });
    },
    // 提交
    async submit() {
