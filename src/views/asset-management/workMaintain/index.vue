  ...
  <basic-container>
    ...
    >
      <el-form ref="form" :model="form" label-width="90px" class="form-footer">
        <el-form-item label="工单号:" prop="workOrderSn">
          <el-input placeholder="请输入" v-model="form.workOrderSn"></el-input>
        </el-form-item>
        <el-form-item label="工单名称:" prop="planName">
          <el-input placeholder="请输入" v-model="form.planName"></el-input>
        </el-form-item>
        <el-form-item label="保养部门:" prop="maintenanceDepartment">
          <el-input
            placeholder="请输入"
            v-model="form.maintenanceDepartment"
          ></el-input>
        </el-form-item>
    ...
    <el-row class="operation-function">
      <el-button
        v-if="permission.workMaintain_expore"
        size="small"
        icon="el-icon-search"
        type="primary"
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="workOrderSn" label="工单号"> </el-table-column>
        <el-table-column prop="planName" label="工单名称"> </el-table-column>
        <el-table-column prop="maintenance" label="保养人"> </el-table-column>
        <el-table-column prop="maintenanceDepartment" label="保养部门">
        </el-table-column>
        ...
        <el-table-column width="130" label="操作" fixed="right">
          <template slot-scope="scope">
            <el-tooltip
              v-if="permission.workMaintain_return"
              class="item"
              effect="dark"
              content="指派"
              placement="bottom"
            ...
            <el-tooltip
              v-if="permission.workMaintain_set"
              class="item"
              effect="dark"
              content="操作"
              placement="bottom"
            ...
            <el-divider direction="vertical"></el-divider>
            <el-tooltip
              v-if="permission.workMaintain_detail"
              class="item"
              effect="dark"
              content="详情"
              placement="bottom"
            ...
            <el-divider direction="vertical"></el-divider>
            <el-tooltip
              v-if="permission.workMaintain_delete"
              class="item"
              effect="dark"
              content="删除"
              placement="bottom"
    ...
    >
      <el-form
        ...
        class="form-footer"
      >
        <el-form-item label="执行保养部门:" prop="billNo">
          <el-select
        ...
        <el-form-item label="执行人:" prop="billNo">
          <el-select
            v-model="ruleForm.maintenanceId"
            placeholder="请选择"
  ...
  methods: {
    ...
    applicantTypes1(value) {
      this.userList.forEach((item) => {
        if (item.id === value) {
          this.ruleForm.maintenance = item.name;
        }
      });
    },
    // 指派弹框显示
    ...
    handleEdit(row) {
      ...
      // if(row.status==3){}
      this.$router.push({
        path: "/asset-management/workMaintain/edit",
        query: {
          data: row,
        },
      });
